...
-- Drop and recreate the handle_new_admin_user function with correct column reference
...
-- Drop and recreate the log_admin_changes function with correct column reference
